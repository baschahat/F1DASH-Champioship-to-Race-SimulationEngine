...
# Create gradient rectangle covering entire figure
gradient_bg = fig.add_axes([0, 0, 1, 1], zorder=-1000)
gradient_bg.axis('off')

# Define gradient (dark gray to black, top to bottom)
gradient = gradient_bg.imshow([[0], [1]], 
                              cmap=LinearSegmentedColormap.from_list('bg', ['#1a1a1a', '#000000']),
